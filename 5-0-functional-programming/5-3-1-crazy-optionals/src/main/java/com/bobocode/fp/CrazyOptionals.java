...
public class CrazyOptionals {
     ...
     *
     * @param text Potential value for Optional
     ...
     *
     * @param accountProvider instance of AccountProvider
     ...
     *
     * @param accountProvider instance of AccountProvider
     * @param defaultAccount  instance of Account
     ...
     *
     * @param accountProvider  instance of AccountProvider
     * @param fallbackProvider instance of AccountProvider
     ...
     *
     * @param accounts       list of all accounts
     * @param accountService interface for account's processing
     */
    ...
    public static double calculateTotalCreditBalance(List<CreditAccount> accounts) {
        return accounts.stream()
                ...
                .map(balance -> balance.orElse(new BigDecimal("0")))
